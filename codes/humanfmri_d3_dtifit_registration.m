...
for subj_i = 1:numel(preproc_subject_dir)
    ...
    system(['export FSLOUTPUTTYPE=NIFTI;' ...
        ' dtifit' ...
        ' --data=' PREPROC.dwi_cleaned_nii_file ...
    ...
    PREPROC.dwi_FA_file = [PREPROC.dwi_dtifit.dtifit_out '_FA.nii'];
    
    PREPROC.coreg_anat_file_betfordwi = fullfile(PREPROC.preproc_anat_dir, [PREPROC.subject_code, '_T1w_bet.nii']);
    system(['export FSLOUTPUTTYPE=NIFTI; bet ', PREPROC.coreg_anat_file, ' ', PREPROC.coreg_anat_file_betfordwi, ' -f 0.5']);
    ...
    system(['export FSLOUTPUTTYPE=NIFTI;' ...
        ...
        ' --out=' PREPROC.merged_MNItoDWI ...
        ' --ref=' PREPROC.epireg_ref_firstb0]);
    
    PREPROC.dwi_FA_normalized_file = [PREPROC.dwi_dtifit.dtifit_out '_FA_normalized.nii'];
    system(['export FSLOUTPUTTYPE=NIFTI;' ...
        ' applywarp' ...
        ' --ref=/usr/local/fsl/data/standard/MNI152_T1_2mm.nii.gz' ...
    ...
    FA_normalized_png = fullfile(PREPROC.qcdir, 'FA_normalized.png');
    canlab_preproc_show_montage(PREPROC.dwi_FA_normalized_file, FA_normalized_png);
    drawnow;
